...
int ArpSearchTable(struct in_addr *in_addr, u_int8_t mac[6]);
int ArpShowTable();
int GetTargetMac(int soc, struct in_addr *in_addr, u_int8_t dmac[6], int gratuitous);
int ArpSend(int soc, u_int16_t op, u_int8_t e_smac[6], u_int8_t e_dmac[6],
    u_int8_t smac[6], u_int8_t dmac[6], int8_t saddr[4], u_int8_t daddr[4]);
